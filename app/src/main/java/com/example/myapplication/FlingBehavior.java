...
/**
 * @ProjectName: feicuiyanpin-4.0.0
 * @Package: com.feicuiyanpin.app.widgets.spannablestringbuilder
 * @ClassName: FlingBehavior
 * @Description: java类作用描述
 * @Author: 作者名
 * @CreateDate: 2019/11/7 14:22
 * @UpdateUser: 更新者：
 * @UpdateDate: 2019/11/7 14:22
 * @UpdateRemark: 更新说明：
 * @Version: 1.0
 */
